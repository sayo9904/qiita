...
tags:
  ...
  - WSL2
private: false
updated_at: "2025-10-21T01:05:58+09:00"
id: 70324e9ed56791af98b5
...
VSCode 等から Docker コマンド相当の機能を使う際にも役立ちます。

```bash
sudo usermod -aG docker $USER
```

### DevContainer 用の設定 ※VSCode ユーザー向け

以下を `settings.json` に記載しておくことで、wsl を起動していなくてもリモートエクスプローラーから一発で DevContainer を起動できます。

:::note info
VSCode 側の都合で Windows 側へ DockerDesktop がインストールされる事故を防ぐことができます
:::
